      ...
      <ul className={`flex gap-7 ${font}`}>
        ...
        <li
          ...
          >
            Edit
            {open1 && (
              <ul className={`absolute left-0 mt-0 bg-gray-800 shadow-xl rounded-lg w-40 py-2 animate-fadeIn border border-gray-1000 ${font}`}>
          ...
          >
            Generate
            {open3 && (
              <ul className={`absolute left-0 mt-0 bg-gray-800 shadow-xl rounded-lg w-60 py-2 animate-fadeIn border border-gray-1000 ${font}`}>
                <li className="px-4 py-2 hover:bg-gray-700 hover:text-white cursor-pointer">
                  Generate UVM TestBench
                </li>

                <li className="px-4 py-2 hover:bg-gray-700 hover:text-white cursor-pointer border-b border-gray-700">
                  Generate Report
                </li>
          ...
          >
            Generate View
            {open4 && (
              <ul className={`absolute left-0 mt-0 bg-gray-800 shadow-xl rounded-lg w-35 py-2 animate-fadeIn border border-gray-1000 ${font}`}>
                <li className="px-4 py-2 hover:bg-gray-700 hover:text-white cursor-pointer border-b border-gray-700">
                  Hierarchy View
                </li>
              </ul>
